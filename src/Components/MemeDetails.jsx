...
import { FaThumbsUp, FaThumbsDown, FaShareAlt, FaSmile } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:text-white dark:bg-gray-900 p-6">
      ...
      <div className="flex gap-6 mt-4">
        <button onClick={handleLike} className="flex items-center gap-2 text-green-600 dark:text-green-400 hover:scale-105 transition">
          <FaThumbsUp /> {likes}
        </button>
        ...
        <button onClick={handleShare} className="flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:scale-105 transition">
          <FaShareAlt /> Share
        </button>
      </div>
